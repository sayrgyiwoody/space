...
ScrollReveal().reveal('.navbar-brand',{delay : 700 , origin : 'left'});
ScrollReveal().reveal('#recommend-posts',{delay : 500 , origin : 'top'});
ScrollReveal().reveal('#latest-posts',{delay : 800 , origin : 'top'});
